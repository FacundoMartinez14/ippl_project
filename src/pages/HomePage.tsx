  ...
  return (
    <div className="min-h-screen">
      <div className="space-y-24">
        ...
        {/* CTA Section */}
        <section className="w-full rounded-t-3xl py-20 flex flex-col md:flex-row items-center justify-between px-8 mt-16 bg-white" data-aos="fade-up">
          <div className="max-w-xl mx-auto md:mx-0 text-center md:text-left">
            <h2 className="text-4xl md:text-5xl font-extrabold text-[#374151] mb-4">Comienza tu camino hacia el bienestar</h2>
            <p className="text-lg text-[#374151] mb-8">Nuestro equipo de profesionales está listo para acompañarte en tu proceso terapéutico.</p>
            <a href="/contacto" className="inline-block px-8 py-4 text-lg font-semibold rounded-full bg-[#F28882] text-[#374151] hover:bg-[#F28882]/90 transition-all transform hover:scale-110 focus:scale-105 focus:outline-none focus:ring-2 focus:ring-[#F28882]">Agenda tu consulta</a>
          </div>
        </section>
      </div>
    </div>
